...
# derivar y hacer minuscula cada palabra
ignore_words = ['?', '.', '!','.']
...
for (pattern_sentence, tag) in xy:
    # X: bolsa de palabras para cada pattern_sentence
...
class ChatDataset(Dataset):
    ...
    # admitir la indexación de modo que el conjunto de datos [i] se pueda usar para obtener la i-th muestra
